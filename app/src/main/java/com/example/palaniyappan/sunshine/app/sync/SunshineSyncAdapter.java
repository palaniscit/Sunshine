package com.example.palaniyappan.sunshine.app.sync;
...
import com.example.palaniyappan.sunshine.app.DetailActivity;
import com.example.palaniyappan.sunshine.app.MainActivity;
import com.example.palaniyappan.sunshine.app.R;
import com.example.palaniyappan.sunshine.app.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            final String APP_ID = "deabba3159d7a6f2abb060bda19807a2";
    ...
    private void notifyWeather() {
        ...
        if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
            ...
            if (cursor.moveToFirst()) {
                ...
                // Create the intent on click of notification
                Intent weatherDetailIntent = new Intent(context, MainActivity.class);

                TaskStackBuilder stackBuilder = TaskStackBuilder.create(context);
                stackBuilder.addParentStack(MainActivity.class);
                stackBuilder.addNextIntent(weatherDetailIntent);

                PendingIntent weatherDetailPendingIntent = stackBuilder.getPendingIntent(
                        0,
                        PendingIntent.FLAG_UPDATE_CURRENT
                );
                mBuilder.setContentIntent(weatherDetailPendingIntent);
